...
export const listReservations = async (req, res) => {
  try {
    ...
    return createResponse(res, 200, 'Reservations fetched', { reservations });
  } catch (error) {
...
export const checkAvailability = async (req, res) => {
  try {
    ...
    return createResponse(res, 200, 'Availability checked', { available });
  } catch (error) {
    return createError(res, 500, 'Failed to check availability', 'SERVER_ERROR');
  }
};
...
export const updateReservationStatus = async (req, res) => {
  try {
    ...
    return createResponse(res, 200, 'Reservation status updated', { reservation: updated });
  } catch (error) {
...
export const cancelReservation = async (req, res) => {
  try {
    ...
    return createResponse(res, 200, 'Reservation cancelled', { reservation: updated });
  } catch (error) {
