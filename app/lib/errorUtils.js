...
//      return   safeTranslate(t, 'auth:checkCredentialsorRegister', 'Check your credentials or register');
//     }
//     if (/too\s+many\s+login\s+attempts/.test(s)&&/too\s+many\s+requests/.test(s)) {
//         return   safeTranslate(t, 'auth:tooManyLoginAttempts', 'Check your credentials or register');
//        }
//     return suggestion;
//   }
