export const uiResources = {
  ...
  ar: {
    ...
    home: {
      hero: {
        badge: 'جديد: إطلاق المكافآت — اكسب نقاطًا مع كل طلب',
        title: 'مأكولات مكسيكية أصيلة. <primary>توصيل سريع.</primary>',
        desc: 'من أطباق الشارع إلى الوصفات المطهوة ببطء. اطلب خلال ثوانٍ، احجز فورًا، وتابع التوصيل مباشرة — كل ذلك في مكان واحد.',
        orderNow: 'اطلب الآن',
        reserve: 'احجز طاولة',
        ...
        card: { title: 'اختيار الشيف', desc: 'بارباكوا مطهية ببطء مع صلصة خضراء طازجة وتورتيلا دافئة.' }
      },
      logo: { heading: 'موثوق من عشّاق الطعام المحليين وذُكر في' },
      explore: { heading: 'استكشف القائمة', tacos: 'تاكو', bowls: 'أطباق', drinks: 'مشروبات', coming: 'قريبًا.', chefNotes: 'ملاحظات الشيف: المفضل لدى الجميع مع كزبرة طازجة وعصير ليمون.', viewMore: 'عرض المزيد' },
      loyalty: { heading: 'الولاء والمكافآت', membersSave: 'الأعضاء يوفرون أكثر', points: 'نقطة', nextAt: 'المكافأة التالية عند {{points}}', freeDessert: 'تحلية مجانية', join: 'انضم لبرنامج المكافآت', perks: 'عرض المزايا' },
      why: {
      ...
      events: {
        heading: 'فعاليات جماعية وتموين',
        desc: 'احجز لـ 8+ أشخاص أو خطط لتموين المكاتب خلال دقائق.',
        plan: 'خطط فعالية',
        catering: 'تموين',
        q1: { question: 'هل لديكم قوائم ثابتة؟', answer: 'نعم — قوائم للمجموعات من 8–30، مع خيارات نباتية.' },
        q2: { question: 'كم المدة المناسبة للحجز؟', answer: 'نوصي بـ 48 ساعة؛ وقد يتوفر نفس اليوم خارج الذروة.' }
      },
      offers: { heading: 'عروض موسمية', badge: 'لفترة محدودة', bundle: 'باقة تاكو الثلاثاء', deal: '2 تاكو + مشروب — $9.99', endsIn: 'ينتهي خلال', orderBundle: 'اطلب الباقة', viewDetails: 'عرض التفاصيل' },
      testimonials: {
      ...
      faq: { heading: 'الأسئلة الشائعة', q1: { question: 'هل لديكم خيارات نباتية؟', answer: 'نعم، الكثير! العديد من التاكو والأطباق لدينا تحتوي على خيارات نباتية.' }, q2: { question: 'كم تستغرق عملية التوصيل؟', answer: 'في المتوسط، أقل من 35 دقيقة حسب الوقت والمسافة.' }, q3: { question: 'هل يمكنني تغيير الحجز؟', answer: 'يمكنك تعديل حجزك حتى ساعتين قبل موعدك.' } },
      cta: {
    ...
    menu: {
      hero: { title: 'استكشف قائمتنا', subtitle: 'أطباق من إعداد الطهاة، مكونات طازجة، وعروض موسمية.' },
      actions: { searchPlaceholder: 'ابحث عن الأطباق…', search: 'بحث', sortBy: 'ترتيب حسب', sort: { popular: 'الأكثر رواجًا', priceLow: 'السعر: من الأقل إلى الأعلى', priceHigh: 'السعر: من الأعلى إلى الأقل', newest: 'الأحدث' }, add: 'أضف إلى الطلب', unavailable: 'غير متاح', noItems: 'لا توجد عناصر.' },
  ...
  de: {
    ...
    home: {
      ...
      logo: { heading: 'Beliebt bei Foodies und vorgestellt in' },
      explore: {
      ...
      events: {
        ...
        desc: 'Für 8+ Personen buchen oder Office‑Catering in Minuten planen.',
        plan: 'Event planen',
        catering: 'Catering',
        q1: { question: 'Bieten Sie fixe Menüs an?', answer: 'Ja — Menüs für Gruppen von 8–30, mit vegetarischen Optionen.' },
        q2: { question: 'Wie früh soll ich buchen?', answer: 'Wir empfehlen 48 Stunden; am selben Tag evtl. außerhalb der Stoßzeiten möglich.' }
      },
      offers: {
      ...
      values: {
        heading: 'Beschaffung & Werte',
        desc: 'Wir setzen auf frische, lokale Zutaten und nachhaltige Praktiken — von der Küche bis zum Tisch.',
        badges: {
      ...
      value: {
        reorderDesc: 'Wiederbestellen mit einem Tipp, gespeicherte Favoriten und Apple/Google Pay.',
      ...
      how: {
        ...
        step3: { title: 'Verfolgen & genießen', desc: 'Bestellung live verfolgen oder Reservierung am Eingang vorzeigen.' }
      },
      faq: {
        heading: 'Häufige Fragen',
        q1: { question: 'Bietet ihr vegetarische Optionen?', answer: 'Ja, viele! Viele unserer Tacos und Bowls haben vegetarische Optionen.' },
        q2: { question: 'Wie lange dauern Lieferungen?', answer: 'Im Schnitt unter 35 Minuten, je nach Zeit und Entfernung.' },
        q3: { question: 'Kann ich meine Reservierung ändern?', answer: 'Du kannst deine Reservierung bis 2 Stunden vor deinem Termin ändern.' }
      },
      popular: {
        ...
        coming: 'Eine köstliche Auswahl kommt bald.',
        chefSpecial: 'Chef‑Empfehlung #{{num}}',
        numberOne: '⭐ Nr. 1 bestellt',
        trending: '🔥 Im Trend',
        rating: '★{{rating}} ({{reviews}} Bewertungen)',
        onlyLeftToday: 'Nur noch {{count}} heute!',
        orderNowDelivery: 'Jetzt bestellen – Lieferung in {{mins}} Min'
      },
      sticky: {
